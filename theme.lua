...
EXPORTS = {
    ...
    SwitchColorTheme = function(theme)
        ...
        elseif theme == 2 then
            ...
            colors[clr.TextDisabled]         = ImVec4(0.64, 0.49, 0.49, 1.00)
            colors[clr.WindowBg]             = ImVec4(0.11, 0.15, 0.17, 1.00)
            colors[clr.ChildWindowBg]        = ImVec4(0.15, 0.18, 0.22, 0.00)
            colors[clr.PopupBg]              = ImVec4(0.08, 0.08, 0.08, 0.94)
            colors[clr.Border]               = ImVec4(0.59, 0.13, 0.13, 1.00) -- ImVec4(0.43, 0.43, 0.50, 0.50)
            colors[clr.BorderShadow]         = ImVec4(0.00, 0.00, 0.00, 0.00)
            ...
            colors[clr.HeaderHovered]        = ImVec4(0.98, 0.38, 0.26, 0.80) -- ImVec4(0.98, 0.38, 0.26, 0.80)
            colors[clr.HeaderActive]         = ImVec4(0.98, 0.26, 0.26, 1.00) -- ImVec4(0.98, 0.26, 0.26, 1.00)
            colors[clr.Separator]            = ImVec4(0.59, 0.13, 0.13, 1.00) -- ImVec4(0.94, 0.94, 0.94, 0.20)
            ...
            colors[clr.PlotHistogram]        = ImVec4(0.90, 0.70, 0.00, 1.00)
            colors[clr.PlotHistogramHovered] = ImVec4(1.00, 0.60, 0.00, 1.00)
            colors[clr.TextSelectedBg]       = ImVec4(0.59, 0.13, 0.13, 1.00)--ImVec4(1.00, 0.18, 0.18, 1.00)
